...
Version: v2026.05
Date: March 15, 2026
Merged from: AV_Master_Inventory (Verified intake Jan 19, 2026) | Updated: Dell Precision 7540 network details confirmed Mar 15, 2026
...
1. [💼 Home Office / Studio](#-home-office--studio)
1. [🏋️ Garage / Gym](#%EF%B8%8F-garage--gym)
1. [🌴 Lanai / Pool](#-lanai--pool)
1. [🛏️ Bedrooms](#%EF%B8%8F-bedrooms)
1. [🎸 Instruments & Studio Gear](#-instruments--studio-gear)
1. [🌐 Network Core](#-network-core)
1. [🌡️ Smart Home & Environmental Control](#-smart-home--environmental-control)
1. [🚪 Garage & Utility Systems](#-garage--utility-systems)
1. [🖥️ Family / Reserve Systems](#%EF%B8%8F-family--reserve-systems)
1. [🔗 Cross-Reference Index](#-cross-reference-index)
...
| ---------------------- | ---------------------------------------------------------------------------------------------------------------------- | --------------------------------- | ------------- | ----------------- | ------------------------------------------------------------------------------------------------------------------- |
| Receiver               | [Yamaha R-N800A](https://github.com/MarcArmy2003/The-Audiopheliac/blob/main/docs/Processing_Hardware.md)               | YN8A23090154                      | Apr 2024      | $950              | Network stereo receiver with MusicCast, DAC, Wi-Fi, and AirPlay 2; IP: 192.168.1.191; MAC: 54:B7:BD:9F:AC:18; Wired |
| NAS                    | [QNAP TS-473A](https://github.com/MarcArmy2003/The-Audiopheliac/blob/main/docs/QNAP_TS473A_Specs.md)                   | NAS87828E                         | Oct 2024      | $900              | 4-bay NAS; 16GB RAM; 22TB total (WD Red drives); in entertainment center; IP: 192.168.1.230                          |
...
| Laptop               | [Dell Precision 7540](https://github.com/MarcArmy2003/The-Audiopheliac/blob/main/docs/Dell_Precision_7540_Specs.md)         | 3N1QK93                | Aug 2021      | $850              | Xeon workstation; Samsung 990 PRO SSD + 112GB ECC RAM; Hostname: GDMARCHE; IP: 192.168.1.75; MAC: 4C:1D:96:3F:95:62; Wi-Fi 5GHz (DHCP — reserve recommended) |
| Docking Station      | Dell WD19DCS                                                                                                                | TBD                    | 2026          | $150              | Lanai satellite workspace dock; dual USB-C; 210W PD                                                                                                          |
...
| Router           | Spectrum SAX2V1R                                                                                          | 001CFF2C8D10         | Leased        | N/A               | Wi-Fi 6E router; IP: 192.168.1.1; default credentials: admin / (MAC last 8 chars lowercase) |
...
[Spectrum SAX2V1R Wi-Fi 6E Router] (192.168.1.1)
     ...
     │       ├──► [QNAP TS-473A NAS] (192.168.1.230) — Wired
     │       ├──► [Yamaha R-N800A Receiver] (192.168.1.191) — Wired; MAC: 54:B7:BD:9F:AC:18
     │       ├──► [NVIDIA Shield Pro] — Wired
     │       └──► [TP-Link TL-SG108E Switch]
     │                 ├──► [Focusrite Scarlett Solo / DAW PC]
     │                 └──► [Home Studio Subnet Devices]
     │
     ├──► [Dell Precision 7540 — GDMARCHE] (192.168.1.75) — Wi-Fi 5GHz; MAC: 4C:1D:96:3F:95:62
     ├──► [Samsung NU6950 TV] — Wi-Fi 6
     ├──► [Amazon Echo devices] — Wi-Fi
     ├──► [Smart Home IoT] (Hue, Honeywell, etc.) — Wi-Fi
     └──► [Mobile devices / tablets / phones] — Wi-Fi
```

### 📡 Known IP / Network Device Registry

| Device                  | Hostname  | IP Address    | MAC Address       | Connection | Notes                                    |
| ----------------------- | --------- | ------------- | ----------------- | ---------- | ---------------------------------------- |
| Spectrum SAX2V1R Router | —         | 192.168.1.1   | 001CFF2C8D10      | Gateway    | Admin interface at 192.168.1.1           |
| QNAP TS-473A NAS        | NAS87828E | 192.168.1.230 | —                 | Wired      | UNC: \\NAS87828E\The Audiopheliac        |
| Yamaha R-N800A          | —         | 192.168.1.191 | 54:B7:BD:9F:AC:18 | Wired      | Appears as "Arcadyan 9f:ac:18" in router |
| Dell Precision 7540     | GDMARCHE  | 192.168.1.75  | 4C:1D:96:3F:95:62 | Wi-Fi 5GHz | DHCP — DHCP reservation recommended      |

> ⚠️ **Action Required:** Set a DHCP reservation for GDMARCHE (MAC: 4C:1D:96:3F:95:62) in the Spectrum router admin panel to lock 192.168.1.75 permanently.
...
| ------------ | -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **v2026.05** | Mar 15, 2026   | **CHANGES:** Added Dell Precision 7540 network details: hostname GDMARCHE, IP 192.168.1.75, MAC 4C:1D:96:3F:95:62, Wi-Fi 5GHz (confirmed via Spectrum app). Corrected network topology — Dell is on Wi-Fi, not wired to QSW-1105-5T as previously diagrammed. Added Yamaha R-N800A IP (192.168.1.191) and MAC (54:B7:BD:9F:AC:18) to device table and topology. Added Known IP / Network Device Registry table. Added Dell WD19DCS docking station to Studio inventory. **ACTION REQUIRED:** Set DHCP reservation for GDMARCHE. |
| **v2026.04** | Jan 19, 2026   | Confirmed Technics SL-1200MK2 in Family Room (Ortofon Blue). Moved AT-LP120XUSB to Studio. Moved QNAP TS-473A to Family Room. Added Rolls MB15b, 1Mii RT5066R2 TX/RX units. Moved Bose 3·2·1 to Lanai. Added SVS SoundPath TX/RX routing. Added REI UHD-PRO102, J-Tech AE4KA, Mini AV upscaler to Lanai. Removed fabricated items (Blue Yeti, Rode arm, Zoom pedal).                                                                                                                                                           |
| v2026.03     | Jan 16, 2026   | Relocated AT-LP120XUSB to Family Room. Updated Casio PX-870WE serial. Added TP-Link TL-SG105, APC Back-UPS 1000, Spectrum router SAX2V1R. Added Victrola VTA-71. Validated Seagull SC-6W and Pro-Ject serials.                                                                                                                                                                                                                                                                                                                  |
| v2026.02     | Jan 16, 2026   | Added MacBook Pro (2012), M-Audio Air\|HUB, JBL LSR310S, Yamaha HS7 SNs, Sansui ES-27X3A, Dell Latitude 5340, HyperDrive Dock, LiftMaster MyQ.                                                                                                                                                                                                                                                                                                                                                                                 |
...
| --------------------------- | --------------- | --------------------------------------------------------------------------------- |
| DHCP Reservation — GDMARCHE | **PENDING**     | Set reservation for MAC 4C:1D:96:3F:95:62 → 192.168.1.75 in Spectrum router admin |
...
| Dell WD19DCS Serial         | TBD             | Capture label on dock when accessible                                             |

---

✅ **Revision Complete:**
All intake data merged and verified.
Network device registry added with confirmed IPs and MACs.
Dell Precision 7540 topology corrected from wired to Wi-Fi.
